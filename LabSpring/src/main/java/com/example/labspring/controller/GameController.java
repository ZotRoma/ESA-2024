...
//
//    @PostMapping("/addGame")
//    public String addGame(@RequestParam("WhoWin") String WhoWin,
//                          @RequestParam("NumberKillsRadiant") Integer NumberKillsRadiant,
//                          @RequestParam("NumberKillsDire") Integer NumberKillsDire,
...
//                             @RequestParam("WhoWin") String WhoWin,
//                          @RequestParam("NumberKillsRadiant") Integer NumberKillsRadiant,
//                          @RequestParam("NumberKillsDire") Integer NumberKillsDire,
//                          @RequestParam("Time") Integer Time,
//                           Model model) {
